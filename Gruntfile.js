...
var pluginFile = 'GroupedBulletChart.js';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      watchFiles: {
        files: [pluginFile, 'data/*.csv', 'assets/*.js', 'assets/**/*.js', 'assets/*.css', 'assets/**/*.css', 'assets/**/*.less'],
  ...
  */
  ...
  grunt.registerTask('deploy', ['concat', 'less', 'archive', '_deploy']);
};
